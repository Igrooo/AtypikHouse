...
@NgModule({
  ...
  imports: [
    ...
    MatToolbarModule, MatCardModule, MatSlideToggleModule, MatSnackBarModule, MatMenuModule, MatTabsModule, MatTableModule, MatBadgeModule, MatNativeDateModule, MatDatepickerModule,
